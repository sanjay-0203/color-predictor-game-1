...
export default function LoadingScreen({ onComplete, onSkip }: LoadingScreenProps) {
  ...
  return (
    <div
      ...
      isExiting ? 'opacity-0 scale-95' : 'opacity-100 scale-100'} overflow-hidden`
      }
      style={{
          ...
          <div className="flex-1 text-center relative">
            ...
            <div className="relative">
              ...
              style={{
                ...
                <span className="block animate-float !w-[630px] !h-[157px]">ASYLUM</span>
                <span className="block animate-float-delayed text-gradient-shine !w-[99.9%] !h-[120px]">GAMING</span>
              </h1>
